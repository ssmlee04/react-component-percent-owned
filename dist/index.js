      ...
      var options1 = {
        ...
        scales: {
          ...
          yAxes: [{
            ...
            ticks: {
              fontSize: 12,
              stepSize: Math.max.apply(Math, _toConsumableArray(percent_institutions)) > 50 ? undefined : 0.1,
              fontColor: fontColor
            }
          }]
        }
      ...
      var options2 = {
        ...
        scales: {
          ...
          yAxes: [{
            ...
            ticks: {
              fontSize: 12,
              stepSize: Math.max.apply(Math, _toConsumableArray(percent_insider)) > 50 ? undefined : 0.1,
              fontColor: fontColor
            }
          }]
        }
